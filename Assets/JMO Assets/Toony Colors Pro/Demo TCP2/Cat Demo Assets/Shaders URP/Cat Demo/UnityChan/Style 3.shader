...
/* TCP_DATA u config(ver:"2.4.0";tmplt:"SG2_Template_URP";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","RAMP_MAIN_OTHER","RAMP_SEPARATED","RIM","SHADOW_COLOR_MAIN_DIR","CULLING","BACKFACE_LIGHTING_Z","SHADOW_HSV","TEMPLATE_URP"];flags:list[];keywords:dict[RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0",RIM_LABEL="Rim Lighting",RENDER_TYPE="Opaque"];shaderProperties:list[,,,,,,,,,,,,,,,,,sp(name:"Face Culling";imps:list[imp_enum(value_type:0;value:2;enum_type:"ToonyColorsPro.ShaderGenerator.Culling";op:Multiply;lbl:"Face Culling";gpu_inst:False;locked:False;impl_index:-1)]),,,,,sp(name:"Diffuse Tint";imps:list[imp_mp_color(def:RGBA(1.000, 0.500, 0.000, 1.000);hdr:False;cc:3;chan:"RGB";prop:"_DiffuseTint";md:"";custom:False;refs:"";op:Multiply;lbl:"Diffuse Tint";gpu_inst:False;locked:False;impl_index:-1),imp_spref(cc:3;chan:"AAA";lsp:"Albedo";op:Multiply;lbl:"Diffuse Tint";gpu_inst:False;locked:False;impl_index:-1)])];customTextures:list[]) */
/* TCP_HASH 1841965b6bc2e7079aaee51edc86d735 */
