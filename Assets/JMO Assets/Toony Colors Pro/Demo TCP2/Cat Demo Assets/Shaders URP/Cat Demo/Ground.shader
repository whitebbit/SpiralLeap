...
Shader "Toony Colors Pro 2/Examples URP/Cat Demo/Ground"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			// Copy of URP's GetAdditionalLight() with different falloff calculation
...
/* TCP_DATA u config(ver:"2.4.0";tmplt:"SG2_Template_URP";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","RAMP_MAIN_OTHER","RAMP_SEPARATED","TEXTURE_BLENDING","BLEND_TEX2","BLEND_TEX1","TEXBLEND_HEIGHT","SHADOW_HSV","SHADOW_COLOR_MAIN_DIR","BYPASS_LIGHT_FALLOFF","TEMPLATE_URP"];flags:list[];keywords:dict[RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0",BLEND_TEX2_CHNL="g",BLEND_TEX1_CHNL="r",RENDER_TYPE="Opaque"];shaderProperties:list[,,,,,,,,,,,,,sp(name:"Blending Source";imps:list[imp_vcolors(cc:4;chan:"RGBA";op:Multiply;lbl:"Blending Source";gpu_inst:False;locked:False;impl_index:-1)]),,,sp(name:"Blending Height Contrast";imps:list[imp_constant(type:float;fprc:float;fv:5;f2v:(1.0, 1.0);f3v:(1.0, 1.0, 1.0);f4v:(1.0, 1.0, 1.0, 1.0);cv:RGBA(1.000, 1.000, 1.000, 1.000);op:Multiply;lbl:"Blending Height Contrast";gpu_inst:False;locked:False;impl_index:-1)])];customTextures:list[]) */
/* TCP_HASH 7af6d898cbdacbabc5a39c97977218f6 */
